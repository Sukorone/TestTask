...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none">
        ...
        <path
            fill="var(--iconColor, #000)"
            d="M16.667 6.25h3.125V4.167H5.208v12.5h3.125v2.083H5.208v2.083h14.584v-12.5h-3.125V6.25Zm-1.042 4.167h-3.646a.52.52 0 1 0 0 1.041h1.042a2.604 2.604 0 0 1 .52 5.157v1.093h-2.083v-1.041H9.375v-2.084h3.646a.52.52 0 1 0 0-1.041h-1.042a2.604 2.604 0 0 1-.52-5.157V7.292h2.083v1.041h2.083v2.084ZM3.498 16.667l1.39-1.332-1.442-1.504-3.125 2.995a1.042 1.042 0 0 0-.03 1.473l3.124 3.256 1.503-1.443-1.307-1.362h1.597v-2.083h-1.71Z"
        />
    </svg>
</template>
